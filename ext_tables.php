...
if (TYPO3_MODE === 'BE') {
    ...
    \TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerModule(
        ...
        '',
        array(
            'Backend\\NotificationApplication' => 'index, listAll, show, edit, removeUpload, update, editStatus, updateStatus, notes, addNote, history, clone, confirmClone, sendMassNotification, downloadPdf'
        ),
        array(
            'access'    => 'user,group',
