...
if (TYPO3_MODE === 'BE') {
    ...
    \TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerModule(
        ...
        '',
        array(
            'Backend\\Application' => 'index, list, listAll, listMine, show, edit, saveUpload, removeUpload, update, editStatus, updateStatus, notes, addNote, close, confirmClose, reply, sendReply, invite, sendInvitation, acknowledge, sendAcknowledgement, ratingPerso, rating, addRating, backToPerso, sendBackToPerso, reject, sendRejection, history, clone, confirmClone, new, create, videoInvitation, sendVideoInvitation'
        ),
        array(
            'access'    => 'user,group',
