...
return [
	...
	'columns' => [
        ...
        'meta_title' => [
            'exclude' => 1,
            'label' => 'LLL:EXT:ats/Resources/Private/Language/locallang_db.xlf:tx_ats_domain_model_job.meta_title',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim',
        ...
        'meta_description' => [
            'exclude' => 1,
            'label' => 'LLL:EXT:ats/Resources/Private/Language/locallang_db.xlf:tx_ats_domain_model_job.meta_description',
            'config' => [
                'type' => 'text',
                'cols' => '30',
                'rows' => '5',
